export const MSG_SELECT_MAIN_NET = "Please select main net to proceed!";
export const MSG_SELECT_KOVAN_NET = "Please select kovan net to proceed!";
...
export const MSG_CONNECT_REQUIRED_CHROME = "! In order to connect to MetaMask on a Desktop browser, you must have the plugin installed using a supported browser."
